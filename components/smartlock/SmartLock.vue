  ...
  <div class="smartLock">
    <b-modal id="smartLock" title="SmartLock" hide-footer centered>
        ...
        >
          ...
          >
            ...
            <a
              ...
              @click.stop.prevent="removeAccount(account)"
            >
              <v-icon name="x" />
            </a>
          </div>
      ...
      <div class="text-center mt-3">
        <b-button variant="info" @click="$bvModal.show('smartLockAddAccount')">
          Add Account
        </b-button>
      </div>
    </b-modal>
    ...
    >
      ...
      <div class="text-center">
        <div>
          <b-avatar
            :src="`https://images.hive.blog/u/${unlockingAccount}/avatar`"
            size="100px"
            variant="light"
            class="border"
          />
    ...
    async unlockAccount (username) {
      if (username) {
        ...
        try {
          ...
          this.$root.$emit('smartLockLoggedIn')
